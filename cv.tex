...
\cventry{Apr.~2016--Mar.~2019\\(Expected)}{Ph.D.\ in Information Science}{Osaka University}{Osaka}{}%
...
Laboratory (ORNL)}{TN}{USA}%
{%
Worked on elastic in-situ workflow management
\begin{itemize}%
\item Contributed to ADIOS2, a high-performance data movement middleware
    developed as a part of DoE's Exascale Computing Project~(ECP)
\item Worked on a joint research project between the Japanese Aerospace
    Exploration Agency~(JAXA) and ORNL
\end{itemize}
}
